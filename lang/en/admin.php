...
$string['configloglifetimestart'] = 'What time should the cronjob that does the log pruning <b>start</b>? Please specify different times if there are multiple Moodles on one physical server.';
...
$string['loglifetimestart'] = 'Run at';
