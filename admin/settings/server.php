...
$temp->add(new admin_setting_configtime('loglifetimestarthour', 'loglifetimetartminute', new lang_string('loglifetimestart', 'admin'), new lang_string('configloglifetimestart', 'admin'), array('h' => 0, 'm' => 0)));
...
$temp->add(new admin_setting_configtime('gradehistorylifetimestarthour', 'gradehistorylifetimetartminute', new lang_string('gradehistorylifetimestart', 'grades'), new lang_string('configgradehistorylifetimestart', 'grades'), array('h' => 0, 'm' => 0)));
